...
const SEARCH_BUDGETS: Record<SearchDepth, SearchBudget> = {
  fast: {
    ...
    restQueries: { base: 6, reddit: 32, x: 32, linkedin: 32, youtube: 12 },
    mcpQueries: { base: 3, reddit: 10, x: 10, linkedin: 10, youtube: 5 },
    serpResultsPerQuery: 18,
    mcpScrapeUrls: 4,
    redditUrls: 44,
    redditCommentUrls: 28,
    redditKeywordQueries: 22,
    redditPostsPerQuery: 24,
    redditPostParseLimit: 110,
    redditCommentParseLimit: 220,
    xUrls: 84,
    xParseLimit: 170,
    linkedinUrls: 84,
    linkedinParseLimit: 160,
    youtubeUrls: 28,
    youtubeCommentUrls: 14,
    youtubeVideoParseLimit: 42,
    youtubeCommentParseLimit: 110,
  },
  deep: {
    finalSignals: 1600,
    earlyPreviewSignals: 96,
    restQueries: { base: 16, reddit: 140, x: 140, linkedin: 140, youtube: 40 },
    mcpQueries: { base: 8, reddit: 40, x: 40, linkedin: 40, youtube: 16 },
    serpResultsPerQuery: 24,
    mcpScrapeUrls: 10,
    redditUrls: 210,
    redditCommentUrls: 150,
    redditKeywordQueries: 130,
    redditPostsPerQuery: 48,
    redditPostParseLimit: 340,
    redditCommentParseLimit: 620,
    xUrls: 340,
    xParseLimit: 460,
    linkedinUrls: 340,
    linkedinParseLimit: 420,
    youtubeUrls: 100,
    youtubeCommentUrls: 54,
    youtubeVideoParseLimit: 110,
    youtubeCommentParseLimit: 260,
  },
};
